...
namespace Norns.Destiny.UT.AOT.Structure
{
    ...
    public class TypeSymbolInfoTest
    {
        ...
        public void AccessibilityWhenNormalClass()
        {
            ...
            Assert.Equal(AccessibilityInfo.Internal, dict["Norns.Destiny.UT.AOT.Structure.InternalClass"].Accessibility);
            Assert.Equal(AccessibilityInfo.Public, dict["Norns.Destiny.UT.AOT.Structure.PublicClass"].Accessibility);
        }
    }
}