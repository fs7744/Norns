...
namespace Norns.Extensions.Reflection.Extensions
{
    ...
    {
        internal static readonly MethodInfo GetTypeFromHandle = ReflectorExtensions.GetMethod<Func<RuntimeTypeHandle, Type>>(handle => Type.GetTypeFromHandle(handle));
        internal static readonly MethodInfo GetMethodFromHandle = ReflectorExtensions.GetMethod<Func<RuntimeMethodHandle, RuntimeTypeHandle, MethodBase>>((h1, h2) => MethodBase.GetMethodFromHandle(h1, h2));
